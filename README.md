...
# 📖 [Edfis Tv] <a name="about-project"></a>


**[The Edfis]** is a website that uses the TVmaze API to display information on TV shows and movies. A user has the option to view the movie's metadata, comment, and like. Involvement-API is the foundation for comments and likes.
...
- git clone git@github.com:blessing-michael/Tv-app-capstone.git
